...
run=wandb.init(
    ...
    project="WavLM_Base_6thLayer", # ==================================== Change this ==========================

    # track hyperparameters and run metadata
    config={
    "architecture": "simpleMLP",
    "dataset": "wavLM_Base_6thLayer",
    },name="123 6thLayer",
    reinit=True
)

# Path to feature files
path_features = 'Wavlm_Base/wavlmBase_InterFeat/6th_Layer/' #====================================== Change this ========================== 
extension     = 'csv'
...
# Process label files
gtzan_path_features = "Wavlm_Base/wavlmBase_InterFeat/6th_Layer/" #======================================= Change this ==========================
genre_label_map = {
    "blues": 0,
    "classical": 1,
    "country": 2,

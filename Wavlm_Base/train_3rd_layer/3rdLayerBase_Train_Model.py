...
run=wandb.init(
    ...
    project="WavLM_Base_3rdLayer", # ===================================== Change this ==========================

    # track hyperparameters and run metadata
    config={
    "architecture": "simpleMLP",
    "dataset": "wavLM_Base_3rdLayer",
    },name="123 3rdLayer",
    reinit=True
)

# Path to feature files
path_features = 'Wavlm_Base/wavlmBase_InterFeat/3rd_Layer/' #====================================== Change this ========================== 
extension     = 'csv'
...
# Process label files
gtzan_path_features = "Wavlm_Base/wavlmBase_InterFeat/3rd_Layer/" #======================================= Change this ==========================
genre_label_map = {
    "blues": 0,
    "classical": 1,
    "country": 2,

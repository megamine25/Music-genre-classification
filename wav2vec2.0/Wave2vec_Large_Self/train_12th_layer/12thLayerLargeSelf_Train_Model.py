...
project="Wav2vec_Large_Self_12thLayer"
model_paths="Wav2vec2/Wave2vec_Large_Self/train_12th_layer/"

wandb.login()
run=wandb.init(
    # set the wandb project where this run will be logged
    project=project, # ==================================== Change this ==========================
...
path_features = 'Wav2vec2/Wave2vec_Large_Self/wav2vecLargeself_InterFeat/12th_layer/' #====================================== Change this ========================== 
extension     = 'csv'
...
# Process label files
gtzan_path_features = "Wav2vec2/Wave2vec_Large_Self/wav2vecLargeself_InterFeat/12th_layer/" #======================================= Change this ==========================
genre_label_map = {
    "blues": 0,
    "classical": 1,
    "country": 2,
...
best_model_path = model_paths+'best123_model_6thLayerBase.pth'  # ============================= Change this ===============
...
best_validation_loss = float('inf')
early_stop_counter = 0
best_model_path = model_paths+'best231_model_6thLayerBase.pth'  # ============================= Change this ===============
def calculate_accuracy(outputs, labels):
    _, predicted = torch.max(outputs.data, 1)
    total = labels.size(0)
    correct = (predicted == labels).sum().item()
...
best_validation_loss = float('inf')
early_stop_counter = 0
best_model_path = model_paths+'best312_model_6thLayerBase.pth'  # ============================= Change this ===============
def calculate_accuracy(outputs, labels):
    _, predicted = torch.max(outputs.data, 1)
    total = labels.size(0)
    correct = (predicted == labels).sum().item()

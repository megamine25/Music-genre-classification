...
for file in file_list:
    ...
    file_id = 'Wav2vec2/Wav2vec_Large/wav2vecLarge_InterFeat/6th_layer/'+file.split('/')[2].split('.')[0]+'.'+file.split('/')[2].split('.')[1]+'.csv'
...
#---------------------------------------
    ...
    file_id = 'Wav2vec2/Wav2vec_Large/wav2vecLarge_InterFeat/12th_layer/'+file.split('/')[2].split('.')[0]+'.'+file.split('/')[2].split('.')[1]+'.csv'
    rep_df.to_csv(file_id)
    print(file_id)
#---------------------------------------
    ...
    file_id = 'Wav2vec2/Wav2vec_Large/wav2vecLarge_InterFeat/18th_layer/'+file.split('/')[2].split('.')[0]+'.'+file.split('/')[2].split('.')[1]+'.csv'
    rep_df.to_csv(file_id)
    #print(file_id)
